...
/// <summary>
///     Handles UI window management logic for inventory slots, including loading and saving window states.
/// </summary>
public static class UIWindowManager
{
    ...
    /// <summary>
    ///     Loads user interface data and restores open slot windows.
    /// </summary>
    /// <param name="userInterfaceSaveData">The save data containing window information</param>
    ...
    /// <summary>
    ///     Replaces user interface open slots data with current window states.
    /// </summary>
    /// <param name="saveData">The save data to update</param>
    public static void ReplaceUserInterfaceOpenSlots(UserInterfaceSaveData saveData)
    {
